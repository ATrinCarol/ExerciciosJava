...
public class exercicio4While {
	...
	public static void main(String[] args) {
		...
		String opcao1 = "pessoa calma";
		String opcao2 = "pessoa nervosa";
		String opcao3 = "pessoa agressiva";
		
		while (opcao1==nome) { //VOU CONCERTAR PORQUE ESTÁ BEM BAGUNÇADO. SÓ COLOQUEI ISSO PRA NÃO FICAR COM ERRO
