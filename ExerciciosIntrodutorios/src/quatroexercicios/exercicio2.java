 ...
 * DESCOBRIR PORQUE TÁ DANDO ERRO NA SEQUÊNCIA 
 */
...
public class exercicio2 {
	...
	public static void main(String[] args) {
		...
		System.out.print("Digite 3 números que os colocaremos em ordem crescente:\n");
		...
		if (n1<=n2 && n1<=n3) {
			...
			System.out.println("->" + n3 + "->" + n2 + "->" + n1); //ERRO TAMBÉM
		}
		
		else {
			System.out.println("Você digitou um símbolo inválido para este caso.");
		}
